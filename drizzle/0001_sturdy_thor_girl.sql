...
--> statement-breakpoint
CREATE TABLE "chat-bot_post" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "chat-bot_post_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"name" varchar(256),
...
CREATE INDEX "name_idx" ON "chat-bot_post" USING btree ("name");